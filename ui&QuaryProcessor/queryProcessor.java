...
//    
    public static void Create_Trend_Table(Connection con) throws Exception{
  	  try{
  		//Connection con = getConnection();
  		java.sql.PreparedStatement create = con.prepareStatement("CREATE TABLE IF NOT EXISTS TRENDS(Name VARCHAR (30) NOT NULL,Rank INT NOT NULL,Country VARCHAR (100) NOT NULL,PRIMARY KEY (Name)"); 
